...
item_model = item_ns.model('Item', {
    ...
    'latitude': fields.Float(required=True, example=-23.5615),
    'longitude': fields.Float(required=True, example=-46.6559)
})
...
class OptimizeRoute(Resource):
    @jwt_required()
    def get(self):
        # DESAFIO DE LÓGICA: Algoritmo de Vizinho Mais Próximo com Capacidade
